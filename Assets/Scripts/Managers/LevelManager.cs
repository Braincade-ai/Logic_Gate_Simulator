...
{
    public GameManager componentData;
    public GameObject nodePrefab;
    public GameObject wirePrefab;

    [HideInInspector]
    public int inputs, outputs = 1;
    private GameManager.ComponentType componentType;
    ...
    void UpdateWires()
    {
        ...
        {
            LevelManager from = connection.output; //OUTPUT
            LevelManager to = connection.input; //INPUT
    ...
    private void Update()
    {
        ...
        {
            case GameManager.ComponentType.AND: //AND GATE 
                ...
                break;
            case GameManager.ComponentType.OR: //OR GATE
                ...
                componentActive = false;
                break;
            case GameManager.ComponentType.NAND: //NOT AND GATE
                ...
                break;
            case GameManager.ComponentType.NOR: //NOT OR GATE
                if (activeConnections == 0)
                {
                    componentActive = true;
                }
                ...
                break;
            case GameManager.ComponentType.NOT: //NOT Gate
                if (activeConnections == 0)
                {
                ...
                break;
            case GameManager.ComponentType.XOR: //Exclusive OR GATE
                ...
                break;
            case GameManager.ComponentType.XNOR: //Exclusive NOR GATE
                if (activeConnections == 0 || activeConnections >= connections.Count)
                {
                    componentActive = true;
                }
                ...
                break;
            case GameManager.ComponentType.POWER:
                componentActive = true;
                break;
            case GameManager.ComponentType.LIGHT:
                if (activeConnections > 0)
                {
                    componentActive = true;
                    spr.color = componentData.componentColor;
    ...
    public void IncreaseInputs()
    {
        ...
        if (componentType != GameManager.ComponentType.POWER)
        {
...
{
    public LevelManager input;
    public LevelManager output;
    public LineRenderer wire=null;

    public int outputNode;
    public int inputNode;

    public Connection(LevelManager input, LevelManager output)
    {
        this.input = input;
        this.output = output;
    }
